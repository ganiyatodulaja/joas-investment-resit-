...
$error = '<div class="alert alert-danger border-0" role="alert">
                                    <strong>Error!</strong> There was error updating this client.
                                </div>';
$success = '<div class="alert alert-success border-0" role="alert">
                                    <strong>Success!</strong> Changes to the client details have been modified successfully.
                                </div>';
...
?> 
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title p-3">UPDATE CLIENT INFORMATION</h4>
                            </div><!--end card-header-->
                            <div class="card-body">
                                <div class="row">
									<?php
                                    if(isset($_GET['encrypt-key'])){
                                        $id = $_GET['encrypt-key'];
                                        $client = mysqli_fetch_array(mysqli_query($db,"SELECT * FROM client WHERE clientid='$id'"));
                                    }
                                if(isset($_POST['post-data'])){
                                    ...
                                    $abs = "successfully modified a client details";
                                    $update = mysqli_query($db,"UPDATE client SET firstname='$firstname', lastname='$lastname', email='$email', address1='$address1', address2='$address2', country='$country', dob='$dob', gender='$gender', phone='$phone', income='$income', occupation='$occupation' WHERE clientid='$id'");
                                    if($update){
                                ...
                                ?>
                                    ...
                                    <div class="col-md-12 row">
                                        ...
                                        <input class="form-control" value="<?php echo $client['firstname']; ?>" name="firstname" placeholder="Enter first Name" required>
                                      </div>
                                        <div class="col-md-4 mb-3">
                                        <label>Last Name</label>
                                        <input class="form-control" name="lastname" required value="<?php echo $client['lastname']; ?>">
                                      </div>
                                        <div class="col-md-4 mb-3">
                                        <label>Email <span class="text-danger">*</span></label>
                                        <input type="email" required name="email" value="<?php echo $client['email']; ?>" class="form-control">
                                      </div>
                                      </div>
                                    <div class="col-md-12 row">
                                        <div class="col-md-4 mb-3">
                                        <label>Address Line 1 <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="address1" required value="<?php echo $client['address1']; ?>">
                                      </div>
                                        <div class="col-md-4 mb-3">
                                        <label>Address Line 2 <span class="text-muted">(Optional)</span></label>
                                        <input type="text" class="form-control" name="address2" value="<?php echo $client['address2']; ?>">
                                      </div>
                                        <div class="col-md-4 mb-3">
                                    ...
                                    <div class="col-md-12 row">
                                        ...
                                        <input type="date" value="<?php echo $client['dob']; ?>" class="form-control" name="dob" required>
                                      </div>
                                        <div class="col-md-4 mb-3">
                                        <label>Gender <span class="text-danger">*</span></label>
                                        <select class="form-select select2" name="gender" required>
                                            <option value="<?php echo $client['firstname']; ?>" selected><?php echo $client['gender']; ?></option>
    ...
    <option value="<?php echo $client['firstname']; ?>"><?php echo $client['country']; ?></option>
...
<option value="Zimbabwe">Zimbabwe</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="text" class="form-control" id="income" name="income" value="<?php echo $client['income']; ?>">                               
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-2">
  ...
  <select class="form-select select2" id="occupation" name="occupation">
    <option value="<?php echo $client['occupation']; ?>" selected="selected"><?php echo $client['occupation']; ?></option>
