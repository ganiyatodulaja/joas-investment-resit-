                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                $query = mysqli_query($db,"SELECT * FROM product ORDER BY add_date DESC");
                                                while($prod = mysqli_fetch_array($query)){
                                                ?>
                                            <tr>
                                                <td>
                                                    <img src="assets/images/products/<?php echo $prod['image']; ?>" alt="" height="40">
                                                    <p class="d-inline-block align-middle mb-0">
                                                        <a href="#" class="d-inline-block align-middle mb-0 product-name"><?php echo $prod['name']; ?></a> 
                                                        <br>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <a href="new-product" class="btn btn-outline-light btn-sm px-4 ">+ Add New</a>
                                        </div><!--end col-->      
                                        <div class="col-auto">
                                            <nav aria-label="...">
